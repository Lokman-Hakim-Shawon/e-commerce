...
const AdsSlider = () => {
    ...
    return (
        <div className='flex justify-between items-center bg-white py-2 my-4 px-4 space-x-4'>
            {
                adsData.map((data,index)=><div key={index} className=" flex items-center space-x-4 border-r border-slate-300 p-4 text-xs text-gray-600 font-bold">
